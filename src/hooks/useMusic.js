...
export const useMusic = () => {
    ...
    return {allSongs, handlePlaySong, currentTrack,currentTrackIndex,formatTime,setCurrentTime,currentTime, duration,setDuration,nextTrack,prevTrack,play,pause,isPlaying,volume,setVolume};
}   